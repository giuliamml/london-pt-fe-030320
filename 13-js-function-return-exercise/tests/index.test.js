...
describe("randomNumber", () => {
	test("should return random number", () => {
		const theRandomNumber = randomNumber();

		expect(theRandomNumber !== randomNumber()).toBeTruthy();
	});

	test("should return number between 1 and 10", () => {
		const theRandomNumber = randomNumber();

		expect(theRandomNumber > 0 && theRandomNumber <= 10).toBeTruthy();
	});

	test("returned number should be integer", () => {
		const theRandomNumber = randomNumber();

		expect(theRandomNumber === Math.floor(theRandomNumber)).toBeTruthy();
	});
});
