...
function syncCookMeal(array) {
  array.forEach((el) => syncCookIngredient(el));
...
function asyncCookIngredient({ name, time }) {
...
function asyncCookMeal(array) {
  promisesArray = [];

  array.forEach((el) => promisesArray.push(asyncCookIngredient(el)));
